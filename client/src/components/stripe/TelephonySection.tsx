...
export function TelephonySection() {
  return (
    <section id="telephony" className="py-20 sm:py-28 lg:py-36 relative overflow-hidden bg-[#030014]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-20">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-2xl bg-[#0a0a1a] border border-[#1f1f35] overflow-hidden">
              <div className="px-4 py-3 border-b border-[#1f1f35] flex items-center gap-2">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-[#7cffd4]">47</p>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <div className="px-3 py-1.5 rounded-lg bg-[#7cffd4]/10 text-[#7cffd4] text-sm font-medium flex items-center gap-1.5">
                      <PhoneIncoming className="h-4 w-4" />
                      32
                    </div>
                    <div className="px-3 py-1.5 rounded-lg bg-[#a78bfa]/10 text-[#a78bfa] text-sm font-medium flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {callMetrics.map((metric) => (
                    <div key={metric.label} className="p-3 rounded-lg bg-[#1a1a2e] border border-[#2a2a45]">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-[#a78bfa]/10 to-[#6b4cff]/10 border border-[#a78bfa]/20">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs text-[#7cffd4] font-mono">03:24</span>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <Button size="icon" variant="ghost" className="h-8 w-8 text-[#a59ecb]">
                      <Volume2 className="h-4 w-4" />
                    </Button>
                    <Button size="icon" className="h-10 w-10 bg-[#a78bfa] hover:bg-[#a78bfa]/90">
        ...
        >
          <div className="p-6 rounded-2xl bg-[#0a0a1a]/60 border border-[#1f1f35]">
          ...
          <div className="p-6 rounded-2xl bg-[#0a0a1a]/60 border border-[#1f1f35]">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-[#a59ecb]">
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h3 className="text-2xl font-semibold text-white mb-2">Everything you need for modern telephony</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
            {callCapabilities.map((capability) => (
