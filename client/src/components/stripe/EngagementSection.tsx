...
export function EngagementSection() {
  return (
    <section id="engagement" className="py-20 sm:py-28 lg:py-36 relative overflow-hidden bg-[#030014]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <Badge className="mb-4 bg-[#7cffd4]/20 text-[#7cffd4] border-[#7cffd4]/30">
            Engagement
          </Badge>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-6 p-4 rounded-xl bg-[#1a1a2e] border border-[#2a2a45]">
              ...
              <div className="space-y-3">
                {recentInteractions.map((interaction, index) => (
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-[#1a1a2e] border border-[#2a2a45] flex items-center gap-4"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-white text-sm truncate">{interaction.name}</p>
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h3 className="text-2xl font-semibold text-white mb-2">Turn customers into advocates</h3>
