...
const useCases = [
  ...
  },
  {
    ...
    description: "Capture contacts from any source: web, WhatsApp, calls, social media. Everything unified in your platform automatically.",
    icon: Target,
  ...
  },
  {
    ...
    description: "Automated email, SMS and WhatsApp workflows. Intelligent segmentation and nurturing that converts.",
    icon: Megaphone,
  ...
  },
  {
    ...
    description: "Visualize and manage your sales pipeline. Opportunity tracking and accurate revenue forecasting.",
    icon: Users,
    color: "from-[#7cffd4] to-[#6b4cff]",
  ...
  },
  {
    ...
    description: "Real-time dashboards with sales, engagement, and support KPIs. Make data-driven decisions.",
    icon: BarChart3,
